...
final class Source {
   ...
   * a line the parser rejected, stops the scan, so the newline ending it stays with it. A newline is {@code \n} or
  ...
  int leadingStart(int offset) {
    ...
    // Each turn moves to the start of the blank line ending at the newline before index, which is the start of a line
    // once the spaces and tabs have been walked back over.
