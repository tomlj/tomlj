 ...
 * keys becomes a table and a {@code Collection} an array, their values converted the same way; a {@link TomlValue}
 * stores what it holds. {@code null} throws a {@link NullPointerException} and anything else an
...
public interface MutableTomlTable extends TomlTable {
   ...
   *
   * <p>
   * The entry is removed, with the comments attached to it. The unattached comments among this table's elements stay
   * where they are.
   *
   * @param path The key path.
   ...
   * @throws IllegalArgumentException If the key cannot be parsed, {@code placement} is
   *         {@link TomlComment.Placement#UNATTACHED}, or a line of {@code text} cannot be written as a TOML comment.
   * @throws NoSuchElementException If the key is not set.
   * @throws TomlInvalidTypeException If an element of the path preceding the final key is not a table.
   */
   ...
   * @throws IllegalArgumentException If {@code path} is empty, {@code placement} is
   *         {@link TomlComment.Placement#UNATTACHED}, or a line of {@code text} cannot be written as a TOML comment.
   * @throws NoSuchElementException If the key is not set.
   * @throws TomlInvalidTypeException If an element of the path preceding the final key is not a table.
   */
   ...
   * @throws IllegalArgumentException If {@code path} is empty, or {@code placement} is
   *         {@link TomlComment.Placement#UNATTACHED}.
   * @throws NoSuchElementException If the key is not set.
   * @throws TomlInvalidTypeException If an element of the path preceding the final key is not a table.
   */
  ...
  default MutableTomlTable insertCommentBefore(List<String> anchorPath, List<String> lines) {
    return insertCommentBefore(anchorPath, TomlComment.ofLines(lines, TomlComment.Placement.UNATTACHED));
  }
  ...
  default MutableTomlTable insertCommentAfter(List<String> anchorPath, List<String> lines) {
    return insertCommentAfter(anchorPath, TomlComment.ofLines(lines, TomlComment.Placement.UNATTACHED));
  }
